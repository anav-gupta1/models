...
def analyze_symptom_severity_ada(data_path, symptom_name, n_components=1024):
    print(f"\nStarting AdaBoost analysis for {symptom_name.upper()}...")
    set_seed(42)
...
if __name__ == "__main__":
    ...
    for symptom_column in symptom_columns:
        ...
        analyze_symptom_severity_ada("dataset_new.csv", symptom_column) 